          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            >
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                {language === 'en' 
                  ? 'From our foundation in 1942, we have evolved to become a trusted consulting firm with a global reach while maintaining our Japanese heritage and values.'
                  : '1942年の創業以来、私たちは日本の伝統と価値観を維持しながら、グローバルな展開を持つ信頼されるコンサルティング会社へと発展してきました。'}
              </p>
