  ...
  const jobPositions = [
    {
      title:
        language === "en"
          ...
          : "シニアマネジメントコンサルタント",
      location:
        language === "en" ? "Tokyo (Remote Available)" : "東京（リモート可能）",
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-6">
              <div className="text-center">
                ...
                <h4 className="text-sm font-medium mb-2">
                  {language === "en" ? "Submit Application" : "応募書類の提出"}
                </h4>
              ...
              <div className="text-center">
                ...
                <h4 className="text-sm font-medium mb-2">
                  {language === "en" ? "Interview Process" : "面接プロセス"}
                </h4>
                <p className="text-xs text-gray-600">
                  {language === "en"
                    ? "Initial screening followed by team and case interviews"
                    : "初期スクリーニングの後、チーム面接とケース面接"}
                </p>
              </div>
              <div className="text-center">
                <div className="h-10 w-10 bg-primary/10 text-primary flex items-center justify-center rounded-full mx-auto mb-3">
                ...
                <h4 className="text-sm font-medium mb-2">
                  {language === "en" ? "Offer & Onboarding" : "オファーと入社"}
                </h4>
                <p className="text-xs text-gray-600">
                  {language === "en"
                    ? "Successful candidates receive offers and comprehensive onboarding"
                    : "成功した候補者はオファーと包括的な入社オリエンテーションを受けます"}
                </p>
              </div>
            </div>
          </motion.div>
